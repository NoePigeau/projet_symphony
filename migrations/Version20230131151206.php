 ...
 */
final class Version20230131151206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT NOT NULL, submited_by_id INT NOT NULL, PRIMARY KEY(id))');
